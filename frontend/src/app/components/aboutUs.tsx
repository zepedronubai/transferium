...
export default function AboutUs() {
  return (
    <div className='w-full max-w-[1200px] flex gap-10 justify-center md:px-4 px-2'>
      <Image
        alt='about-img'
        src={'/about.webp'}
        width={440}
        height={300}
        className='rounded-2xl md:w-[440px] w-full md:block hidden'
      />
      <div className='flex flex-col md:items-start items-center'>
        <div className='flex flex-col gap-6  md:items-start items-center '>
          ...
          <div className='flex flex-col md:gap-6 gap-3  md:items-start items-center '>
            ...
            />
            {/* DESCRICAO MEDIA */}
            <div className='font-thin text-customGrayDarker md:text-sm text-xs  md:text-start text-center'>
          ...
          <div className='flex md:flex-col flex-row  md:items-start items-center md:justify-center justify-between w-full gap-2 sm:text-xs text-[8px] font-thin text-customGrayDarker '>
