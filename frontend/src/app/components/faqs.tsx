...
export default function Faqs() {
  return (
    <div className='flex md:flex-row flex-col w-full max-w-[1100px] items-center  md:gap-10 gap-0  md:px-4 px-2'>
      <div className='flex flex-col items-start md:gap-4 gap-3 w-full'>
        ...
        <div className='font-light text-sm text-customGrayDarker'>
